...
public class FragmentFamilyInfo extends Fragment {
    ...
    public FragmentFamilyInfo() {
        // Required empty public constructor
    }
    // TODO: Rename and change types and number of parameters
    public static FragmentFamilyInfo newInstance(String param1, String param2) {
        FragmentFamilyInfo fragment = new FragmentFamilyInfo();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_fragment_family_info, container, false);
        setUpUI(view);
        initToolBar(view);
        onClick(view);
        return view;
    ...
    private void initToolBar(View view) {
        ...
        toolbar.setTitle(R.string.familyinfo);
