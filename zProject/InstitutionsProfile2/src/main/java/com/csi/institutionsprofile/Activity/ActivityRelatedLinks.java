...
public class ActivityRelatedLinks extends AppCompatActivity {
    Toolbar toolbar;
    Button buttonBanbesis,buttonHssp,buttonMinistry,buttonDshe;
    @Override
    ...
    private void onClick() {
        ...
        buttonMinistry.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ConnectivityManager connectivityManager= (ConnectivityManager) getSystemService(getBaseContext().CONNECTIVITY_SERVICE);
                if ( connectivityManager.getNetworkInfo(0).getState() == android.net.NetworkInfo.State.CONNECTED ||
        ...
        buttonDshe.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ConnectivityManager connectivityManager= (ConnectivityManager) getSystemService(getBaseContext().CONNECTIVITY_SERVICE);
                if ( connectivityManager.getNetworkInfo(0).getState() == android.net.NetworkInfo.State.CONNECTED ||
    ...
    private void setupUI() {
        ...
        buttonMinistry = (Button) findViewById(R.id.buttonLinkMinistry);
        buttonDshe = (Button) findViewById(R.id.buttonLinkDshe);
    }
