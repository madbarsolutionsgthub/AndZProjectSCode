...
public class Stakeholder {
    ...
    public String getDistrictSingle() {
        String[] separated = district.split(",");
        //Log.d("District Length: " + district, Integer.toString( separated.length ));
        //Log.d("District Name: ", separated[separated.length-1] );
        return separated[separated.length-1].trim();
    }
